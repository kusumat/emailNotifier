...
Ex: node downloadFeaturesXml.js 8.3.0 'C:\Users\Kony\Desktop\featurexml_file'

if proxy is there then follow the bellow command (proxy param is optional)

Ex: node downloadFeaturesXml.js 8.3.0 'C:\Users\Kony\Desktop\featurexml_file' 'http://user_name:password@proxy.server.com:proxy_port'
